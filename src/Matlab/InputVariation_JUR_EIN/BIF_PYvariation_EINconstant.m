...
p_ext_Py=0.0;                   % input to Py 0->no input to Py
p_ext_EIN=60.0;                   % input to EIN 0-> no input to EIN
...
freePamRange(2) = 1.5;
freePamRange(3) = 317;
indexHopf       = 1109;       %get from eigenvalues plot or print ind and points

[ hopfbranch_psol_1 ] = fun_cont_Hopfbr( funcs,fixpointbranch,indexHopf,ind_pPy,freePamRange,160,1 );
...
freePamRange(2) = 2.5;
freePamRange(3) = 317;
indexHopf       = 1901;       %get from eigenvalues plot or print ind and points

[ hopfbranch_psol_2 ] = fun_cont_Hopfbr( funcs,fixpointbranch,indexHopf,ind_pPy,freePamRange,160,1 );
...
print -dpdf 'BIF_InVar_Pysweep_EIN60' -r1000 

BIF_InVar_Pysweep_EIN60={fixpointbranch,hopfbranch_psol_1,hopfbranch_psol_2}
save('BIF_InVar_Pysweep_EIN60.mat','BIF_InVar_Pysweep_EIN60')
