...
print -dpdf 'BIF_Nii33k25_He325_Hi30' -r1000 
bif_Nii33k25_He325_Hi30={fixpointbranch}
save('bif_Nii33k25_He325_Hi30.mat','bif_Nii33k25_He325_Hi30')
...
% 
% load('bif_Nii33k25_He325_Hi25.mat')
% fixpointbranch=bif_Nii33k25_He325_Hi25{1}
...
[upperfold_branch_Hi,s,f,r]=br_contn(funcs,upperfold_branch_Hi,250)           % continue in other direction
xlabel('pext');ylabel('Hi');
...
xlabel('pext');ylabel('Hi');
title('Variation in Hi - 2pop RUM')
legend('upper fold bifurcation branch')
...
[lowerfold_branch_Hi,s,f,r]=br_contn(funcs,lowerfold_branch_Hi,150)           % continue in other direction
xlabel('pext');ylabel('Hi');
...
xlabel('pext');ylabel('Hi');
title('Variation in Hi - 2pop RUM')
legend('lower fold bifurcation branch','upper fold bifurcation branch')


% print -dpdf 'RUM_2popNii_2PamBIF_Hi_pext' -r1000 
%bif_RUM_2popNii_Hi={bif_lfb_Hi,bif_ufb_Hi}
%save('bif_RUM_2popNii_Hi.mat','bif_RUM_2popNii_Hi')
