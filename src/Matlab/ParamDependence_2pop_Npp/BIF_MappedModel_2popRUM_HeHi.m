...
xlabel('He')
ylabel('pyrapot')
title(['He:' num2str(He*1000) 'mV | Hi:' num2str(Hi*1000) 'mV | Npp:' num2str(Npp) '| pext:' num2str(pext)])

print -dpdf 'BIF_RUMhe_pext100' -r1000 
bif_RUMhe_pext100={fixpointbranch,hopfbranch_psol_1}
...
% Ich stelle fest, dass f?r unseren Arbeitspunkt pext=0s-1 kein
% g?ngiges bif-Diagramm mit relevantem (multistabilit?t,Hopf) Verhalten
% erzeugt werden kann, wenn He ver?ndert wird. Aus den bif-Diagrammen von
% Hi k?nnen wir aber einen relevanten Bereich erkennen. Anstatt das He-Hi
% diagramm also aufzustellen (Relevantes Verhalten mappen wenn Hi ver?ndert
% wird), arbeite ich mit dem Hi-He Diagramm (denn erst dort kann relevantes
% Verhalten ?berhaupt erzeugt werden). 
