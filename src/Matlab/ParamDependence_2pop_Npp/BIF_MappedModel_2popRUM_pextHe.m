...
freePamRange(2) = 1.5;
freePamRange(3) = 800;
indexHopf       = 336;       %get from eigenvalues plot or print ind and points

[ hopfbranch_psol_1 ] = fun_cont_Hopfbr( funcs,fixpointbranch,indexHopf,ind_pext,freePamRange,60,0 );
...
print -dpdf 'BIF_Npp113_He3_Hi5k5' -r1000 
bif_Npp113_He3Hi5k5={fixpointbranch,hopfbranch_psol_1}
save('bif_Npp113_He3Hi5k5.mat','bif_Npp113_He3Hi5k5')
...
% 
% load('bif_Npp113_He11Hi22.mat')
% fixpointbranch=bif_Npp113_He11Hi22{1}
% hopfbranch_psol_1=bif_Npp113_He11Hi22{2}
...
figure(6); clf;
[lowerfold_branch_He,s,f,r]=br_contn(funcs,lowerfold_branch_He,250)           % continue with plotting hopf branch:
...
% bif_RUM_2popNpp_He={bif_lfb_He,bif_hopf_He,floq}
% save('bif_RUM_2popNpp_He.mat','bif_RUM_2popNpp_He')
...
[upperfold_branch,s,f,r]=br_contn(funcs,upperfold_branch,350)           % continue in other direction
xlabel('pext');ylabel('He');
...
% bif_RUM_2popNpp_He={bif_ufb_He,bif_lfb_He,bif_hopf_He,floq}
% save('bif_RUM_2popNpp_He.mat','bif_RUM_2popNpp_He')

%print -dpdf 'RUM_2popNpp_2PamBIF_He_pext' -r1000 
