...
currpath = 'EI_Cluster/Data/2nd/2pop/2popNii_HeHi_33k25'
currpath = 'EI_Cluster/Data/2nd/2pop/2popNii_widerImpulseRange'
...
#full2
hirange = np.arange(15,25.1,1.0)*1e-3
herange = np.arange(10.,0.99,-0.5)*1e-3
...
for he in herange:
    j=0    
    for hi in hirange:
        state_grid[i,j,:,:,:]=np.load('RUM_Dec_meas_Nii33k25_HeHi_le500t1500i10msInt50t250i2_He%.2fmV_Hi%.1fmV.npy' %(he*1000,hi*1000))
        #state_grid[i,j,:,:,:]=np.load('RUM_Dec_meas_Nii33k25_le100t1500i10msInt0t250i2_He%.2fmV_Hi%.1fmV.npy' %(he*1000,hi*1000))
...
he=1.5e-3
hi=21e-3
a=np.load('RUM_Dec_meas_Nii33k25_HeHi_le500t1500i10msInt50t250i2_He%.2fmV_Hi%.1fmV.npy' %(he*1000,hi*1000))
...
plt.savefig('fingerprint_2popNii_he%.2f_hi%.0f.eps' %(he*1000,hi*1000), format='eps', dpi=1000)
os.chdir(currpath)
...
plt.figure(4)
plt.savefig('RUM_Detektor_2popNii33k25_sections.pdf', format='pdf', dpi=1000)
plt.figure(3)
plt.savefig('RUM_Detektor_2popNii33k25_axis.pdf', format='pdf', dpi=1000)
plt.figure(3)
