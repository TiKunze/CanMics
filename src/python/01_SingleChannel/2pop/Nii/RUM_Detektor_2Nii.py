...
currpath = '/usr/wrk/people9/tiku2449/EI_RUM/001_Unifying_Framework/RUM_Exploration/2pop/2pop_Nii'
os.chdir(currpath)
...
np.save('RUM_Dec_meas_Nii33k25_le100t1500i10msInt0t250i2_He%.2fmV_Hi%.1fmV.npy' %(he*1000,hi*1000),state_grid)
