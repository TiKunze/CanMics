...
##
os.chdir('/home/raid3/tkunze/Documents/Programming/JansenModels/Kunze_JuR/003_ModelDevelopment/001_Unifying_Framework/EIPy_StateSpaceExploration/EI_Cluster/Data/2nd/2pop/2popNpp_HeHi_full2_windowing')
a=np.load('RUM_Dec_meas_Npp113k4_HeHi_le500t1500i10msInt50t250i2_He3.00mV_Hi5.5mV.npy')
b=a[:,:,0]
c=a[:,:,1]
###############################################################################
#
...
hi_range = np.arange(0,20.1,0.1)*1e-3
...
np.save('RUM_oscitest_2popNpp_he0i0k1t16_hi0i0k1t20_pext0_state_grid.npy',state_grid)
np.save('RUM_oscitest_2popNpp_he0i0k1t16_hi0i0k1t20_pext0_sim_grid.npy',sim_grid)
...
plt.savefig('RUM_2popNpp_oscillationstest.pdf', format='pdf', dpi=1000)
#
